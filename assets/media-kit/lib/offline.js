  ...
  (e.prototype = {
    ...
    execute: function (t) {
      ...
      return (
        this.active &&
          this._listener &&
          ((r = this.params ? this.params.concat(t) : t),
          (e = this._listener.apply(this.context, r)),
    ...
    (n.prototype = {
      ...
      _registerListener: function (t, r, n, i) {
        ...
        return (
          this.memorize && this._prevParams && a.execute(this._prevParams), a
        );
      },
      ...
      _indexOfListener: function (t, e) {
        for (var r, n = this._bindings.length; n--; )
          if ((r = this._bindings[n])._listener === t && r.context === e)
            return n;
        return -1;
      },
      has: function (t, e) {
      ...
      dispatch: function () {
        if (this.active) {
          ...
          if ((this.memorize && (this._prevParams = e), r)) {
            ...
            do {
              r--;
            } while (t[r] && this._shouldPropagate && !1 !== t[r].execute(e));
          }
        }
      },
      forget: function () {
  ...
  (function (t, e, r) {
    ...
    function i() {
      ...
      for (var s in w)
        if (w.hasOwnProperty(s)) {
          ...
          for (
            i = n(e.fn, 'function') ? e.fn() : e.fn, a = 0;
            a < t.length;
            a++
          )
            1 === (o = t[a].split('.')).length
              ? (S[o[0]] = i)
              : (!S[o[0]] ||
                  S[o[0]] instanceof Boolean ||
                  (S[o[0]] = new Boolean(S[o[0]])),
                (S[o[0]][o[1]] = i)),
              b.push((i ? '' : 'no-') + o.join('-'));
        }
    }
    function a(t) {
      ...
      S._config.enableClasses &&
        ((e += ' ' + r + t.join(' ' + r)),
        z ? (M.className.baseVal = e) : (M.className = e));
    }
    function o() {
    ...
    function h() {
      var t = e.body;
      return t || ((t = o(z ? 'svg' : 'body')).fake = !0), t;
    }
    function c(t, r, n, i) {
      var a,
        s,
      ...
      if (parseInt(n, 10))
        for (; n--; )
          ((l = o('div')).id = i ? i[n] : m + (n + 1)), u.appendChild(l);
      return (
    ...
    function m(t, e) {
      if ('object' == typeof t) for (var r in t) E(t, r) && m(r, t[r]);
      else {
        var n = (t = t.toLowerCase()).split('.'),
          i = S[n[0]];
        if ((2 == n.length && (i = i[n[1]]), void 0 !== i)) return S;
        (e = 'function' == typeof e ? e() : e),
          1 == n.length
            ? (S[n[0]] = e)
            : (!S[n[0]] ||
                S[n[0]] instanceof Boolean ||
                (S[n[0]] = new Boolean(S[n[0]])),
              (S[n[0]][n[1]] = e)),
          a([(e && 0 != e ? '' : 'no-') + n.join('-')]),
          S._trigger(t, e);
      }
    ...
    function v(t, e, i, a) {
      ...
      for (
        var m, u, d, p, f, v = ['modernizr', 'tspan', 'samp'];
        !_.style && v.length;

      )
        (m = !0), (_.modElem = o(v.shift())), (_.style = _.modElem.style);
...
!*/
      (S = new S()).addTest('history', function () {
...
!*/
      S.addTest('csspositionsticky', function () {
        var t = 'position:',
          ...
          r = o('a').style;
        return (
          (r.cssText = t + A.join(e + ';' + t).slice(0, -t.length)),
...
!*/
    ...
    (k.atRule = I),
      (O = {}.hasOwnProperty),
      (E =
        n(O, 'undefined') || n(O.call, 'undefined')
          ? function (t, e) {
...
!*/
    ...
    var P = (k.prefixed = function (t, e, r) {
      return 0 === t.indexOf('@')
        ? I(t)
        : (-1 != t.indexOf('-') && (t = l(t)), e ? y(t, e, r) : y(t, 'pfx'));
    });
    /*!
{
  "name": "Fullscreen API",
...
!*/ S.addTest(
      'fullscreen',
      !(!P('exitFullscreen', e, !1) && !P('cancelFullScreen', e, !1))
    ),
      i(),
      a(b),
      delete k.addTest,
  ...
  (function (t, e) {
    ...
    return (function (t) {
      ...
      function (t, e, r) {
        'use strict';
        function n(t) {
          for (var e = 0; e < X.length; e += 2)
            if (t >= X[e] && t <= X[e + 1]) return !0;
          return !1;
        }
        function i(t) {
        ...
        function a(t, e, r) {
          ...
          var i = t.charCodeAt(0),
            a = ht[e][i];
          if (
            (!a && t[0] in mt && ((i = mt[t[0]].charCodeAt(0)), (a = ht[e][i])),
            a || 'text' !== r || (n(i) && (a = ht[e][77])),
            a)
          )
            return {
              depth: a[0],
        ...
        function o(t, e, r, n, i, a) {
          (ft[t][i] = { font: e, group: r, replace: n }),
            a && n && (ft[t][n] = ft[t][i]);
        }
        function s(t, e) {
          var r = l(t, e);
        ...
        function m(t) {
          return t && ('atom' === t.type || pt.hasOwnProperty(t.type))
            ? t
            : null;
        }
        function u(t) {
          ...
          for (
            ...
            if (
              ...
              i[s].hasClass('newline') &&
                (o.pop(),
                o.length > 0 && (a.push(p(o, e)), (o = [])),
                a.push(i[s]));
          o.length > 0 && a.push(p(o, e)),
            r && (((n = p(we(r, e, !0))).classes = ['tag']), a.push(n));
        ...
        function v(t, e, r, n) {
          ...
          i =
            1 === a.length &&
            a[0] instanceof Te &&
            R.contains(['mrow', 'mtable'], a[0].type)
              ? a[0]
              : new Be.MathNode('mrow', a);
        ...
        function k(t, e, r) {
          ...
          if (
            (t.gullet.beginGroup(), t.gullet.macros.set('\\\\', '\\cr'), !o)
          ) {
            var h = t.gullet.expandMacroAsText('\\arraystretch');
            if (null == h) o = 1;
            else if (!(o = parseFloat(h)) || o < 0)
              throw new N('Invalid \\arraystretch: ' + h);
          }
          t.gullet.beginGroup();
          var c = [],
            m = [c],
          ...
          for (d.push(w(t)); ; ) {
            ...
            t.gullet.endGroup(),
              ...
              r && (p = { type: 'styling', mode: t.mode, style: r, body: [p] }),
              c.push(p);
            var f = t.fetch().text;
            if ('&' === f) t.consume();
            else {
              ...
              if ('\\cr' !== f)
                throw new N('Expected & or \\\\ or \\cr or \\end', t.nextToken);
        ...
        function z(t, e, r) {
          for (
            var n = we(t, e, !1),
              i = e.sizeMultiplier / r.sizeMultiplier,
              a = 0;
            a < n.length;
            a++
          ) {
          ...
          L = function Nn(t, e) {
            ...
            if (i && i.start <= i.end) {
              ...
              r === a.length
                ? (n += ' at end of input: ')
                : (n += ' at position ' + (r + 1) + ': ');
              var s = a.slice(r, o).replace(/[^]/g, '$&\u0332');
              n +=
                (r > 15 ? '\u2026' + a.slice(r - 15, r) : a.slice(0, r)) +
                s +
                (o + 15 < a.length
                  ? a.slice(o, o + 15) + '\u2026'
                  : a.slice(o));
        ...
        var $ = {
          ...
          Q = function (t) {
            ...
            for (var r in ((e.className = Z(this.classes)), this.style))
          ...
          tt = function (t) {
            var e = '<' + t;
            this.classes.length &&
              (e += ' class="' + R.escape(Z(this.classes)) + '"');
            var r = '';
            for (var n in this.style)
              this.style.hasOwnProperty(n) &&
                (r += R.hyphenate(n) + ':' + this.style[n] + ';');
            for (var i in (r && (e += ' style="' + R.escape(r) + '"'),
            this.attributes))
              this.attributes.hasOwnProperty(i) &&
                (e += ' ' + i + '="' + R.escape(this.attributes[i]) + '"');
            e += '>';
            ...
            return (
              ...
              (e.toNode = function () {
                ...
                this.classes.length > 0 &&
                  ((e = e || document.createElement('span')).className = Z(
                    this.classes
                  )),
                this.style))
                  this.style.hasOwnProperty(r) &&
              ...
              (e.toNode = function () {
                ...
                return (
                  this.alternate
                    ...
                    : t.setAttribute('d', $[this.pathName]),
                  t
                );
              }),
              (e.toMarkup = function () {
        ...
        for (var Nt = '', Et = 0; Et < Ct.length; Et++) {
          ...
          o('math', vt, bt, Ot, (Nt = String.fromCharCode(55349, 56320 + Et))),
            ...
            o(
              ...
              bt,
              Ot,
              (Nt = String.fromCharCode(55349, 56372 + Et))
            ),
            o('text', vt, 'textord', Ot, Nt),
            o(
              'math',
              ...
              bt,
              Ot,
              (Nt = String.fromCharCode(55349, 56424 + Et))
            ),
            o('text', vt, 'textord', Ot, Nt),
            o(
              'math',
              ...
              bt,
              Ot,
              (Nt = String.fromCharCode(55349, 56580 + Et))
            ),
            o('text', vt, 'textord', Ot, Nt),
            o(
              'math',
              ...
              bt,
              Ot,
              (Nt = String.fromCharCode(55349, 56736 + Et))
            ),
            o('text', vt, 'textord', Ot, Nt),
            o(
              'math',
              ...
              bt,
              Ot,
              (Nt = String.fromCharCode(55349, 56788 + Et))
            ),
            o('text', vt, 'textord', Ot, Nt),
            o(
              'math',
              ...
              bt,
              Ot,
              (Nt = String.fromCharCode(55349, 56840 + Et))
            ),
            o('text', vt, 'textord', Ot, Nt),
            o(
              'math',
              ...
              bt,
              Ot,
              (Nt = String.fromCharCode(55349, 56944 + Et))
            ),
            o('text', vt, 'textord', Ot, Nt),
            Et < 26 &&
              (o(
                ...
                bt,
                Ot,
                (Nt = String.fromCharCode(55349, 56632 + Et))
              ),
              o('text', vt, 'textord', Ot, Nt),
              o(
                'math',
                ...
                bt,
                Ot,
                (Nt = String.fromCharCode(55349, 56476 + Et))
              ),
              o('text', vt, 'textord', Ot, Nt));
        }
        o('math', vt, bt, 'k', (Nt = String.fromCharCode(55349, 56668))),
          o('text', vt, 'textord', 'k', Nt);
        for (var qt = 0; qt < 10; qt++) {
          ...
          o('math', vt, bt, It, (Nt = String.fromCharCode(55349, 57294 + qt))),
            ...
            o(
              ...
              bt,
              It,
              (Nt = String.fromCharCode(55349, 57314 + qt))
            ),
            o('text', vt, 'textord', It, Nt),
            o(
              'math',
              ...
              bt,
              It,
              (Nt = String.fromCharCode(55349, 57324 + qt))
            ),
            o('text', vt, 'textord', It, Nt),
            o(
              'math',
              ...
              bt,
              It,
              (Nt = String.fromCharCode(55349, 57334 + qt))
            ),
            o('text', vt, 'textord', It, Nt);
        }
        ...
        var Pt = [
          ...
          jt = function (t, e) {
            return e.size < 2 ? t : Ft[t - 1][e.size - 1];
          },
          Ut = (function () {
            function t(e) {
              (this.style = void 0),
            ...
            return (
              ...
              (e.havingStyle = function (t) {
                return this.style === t
                  ? this
                  : this.extend({ style: t, size: jt(this.textSize, t) });
              }),
                  ...
                  this._fontMetrics ||
                    (this._fontMetrics = (function (t) {
                      ...
                      if (!ut[(e = t >= 5 ? 0 : t >= 3 ? 1 : 2)]) {
                        ...
                        for (var n in ct)
                          ct.hasOwnProperty(n) && (r[n] = ct[n][e]);
                      }
                      return ut[e];
                    })(this.size)),
                  this._fontMetrics
        ...
        var Vt = Ut,
          ...
          Yt = function (t) {
            return (
              ...
              t in Gt || t in Wt || 'ex' === t
            );
          },
          Xt = function (t, e) {
            var r;
            if (t.unit in Gt)
              r = Gt[t.unit] / e.fontMetrics().ptPerEm / e.sizeMultiplier;
          ...
          Kt = function (t, e, r) {
            return (
              gt[r][t] && gt[r][t].replace && (t = gt[r][t].replace),
              { value: t, metrics: a(t, e, r) }
            );
          },
          Zt = function (t, e, r, n, i) {
            ...
            if (((t = o.value), s)) {
              ...
              ('text' === r || (n && 'mathit' === n.font)) && (l = 0),
                (a = new at(t, s.height, s.depth, l, s.skew, s.width, i));
            } else
              'undefined' != typeof console &&
                console.warn(
          ...
          oe = {
            ...
            makeVList: function (t) {
              ...
              var A = te(['vlist-t'], x);
              return (
                2 === x.length && A.classes.push('vlist-t2'),
                (A.height = m),
                (A.depth = -c),
                A
              );
            ...
            makeOrd: function (t, e, r) {
              ...
              if (l) {
                ...
                if ('boldsymbol' === l || 'mathnormal' === l) {
                  var p =
                    'boldsymbol' === l
                      ? Kt(a, 'Math-BoldItalic', i).metrics
                        ? {
                  ...
                  R.contains($t, a)
                    ...
                    : s
                    ? ((u = ie[l].fontName), (d = [l]))
                    : ((u = ne(l, e.fontWeight, e.fontShape)),
                      (d = [l, e.fontWeight, e.fontShape]));
                if (Kt(a, u, i).metrics) return Zt(a, u, i, e, o.concat(d));
                if (St.hasOwnProperty(a) && 'Typewriter' === u.substr(0, 10)) {
                  for (var f = [], g = 0; g < a.length; g++)
                    f.push(Zt(a[g], u, i, e, o.concat(d)));
                  return re(f);
                }
              }
              if ('mathord' === r) {
                var v = (function (t) {
                  return /[0-9]/.test(t.charAt(0)) || R.contains($t, t)
                    ? { fontName: 'Main-Italic', fontClass: 'mathit' }
              ...
              if ('textord' === r) {
                ...
                if ('ams' === y) {
                  ...
                  return Zt(
                    ...
                    i,
                    e,
                    o.concat('amsrm', e.fontWeight, e.fontShape)
                  );
                }
                if ('main' !== y && y) {
          ...
          we = function (t, e, r, n) {
            ...
            if (1 === t.length) {
              ...
              c &&
                ('sizing' === c.type
                  ? (h = e.havingSize(c.size))
                  : 'styling' === c.type && (h = e.havingStyle(xe[c.style])));
            }
          ...
          ke = function On(t, e, r, n) {
            n && t.push(n);
            for (var i = 0; i < t.length; i++) {
              var a = t[i],
                o = Se(a);
              if (o) On(o.children, e, r);
              else if ('mspace' !== a.classes[0]) {
                var s = e(a, r.node);
                s && (r.insertAfter ? r.insertAfter(s) : (t.unshift(s), i++)),
                  (r.node = a),
              ...
              ? (e &&
                  (t = (function r(t, e) {
                    ...
                    if (n) {
                      var i = n.children;
                      if (i.length) {
                        if ('right' === e) return r(i[i.length - 1], 'right');
                        if ('left' === e) return r(i[0], 'left');
                      }
                    }
                    return t;
                  })(t, e)),
          ...
          Ee = function (t, e) {
            ...
            var i = t.text;
            return R.contains(['\\imath', '\\jmath'], i)
              ? null
              : (gt[n][i] && gt[n][i].replace && (i = gt[n][i].replace),
                a(i, oe.fontMap[r].fontName, n) ? oe.fontMap[r].variant : null);
          },
          Oe = function (t, e, r) {
            if (1 === t.length) {
              var n = Ie(t[0], e);
                ...
                if (
                  ...
                  if (
                    ...
                    d instanceof Ce &&
                      d.text.length > 0 &&
                      ((d.text =
                        d.text.slice(0, 1) + '\u0338' + d.text.slice(1)),
                      a.pop());
                  }
                }
              }
          ...
          Ue = function (t) {
            var e = new Be.MathNode('mo', [new Be.TextNode(De[t.substr(1)])]);
          ...
          Ve = function (t, e) {
            var r = (function () {
                var r = 4e5,
                  n = t.label.substr(1);
                if (
                  R.contains(['widehat', 'widecheck', 'widetilde', 'utilde'], n)
                ) {
                  var i,
                    a,
                    o,
          ...
          We = function (t, e) {
            var r = t.isStretchy
                ? Ue(t.label)
                : new Be.MathNode('mo', [Le(t.label, t.mode)]),
        ...
        u({
          ...
          htmlBuilder: function (t, e) {
            ...
            a.classes.push('x-arrow-pad'),
              t.below &&
                ((i = e.havingStyle(n.sub())),
                (r = oe.wrapFragment(ze(t.below, i, e), e)).classes.push(
                  'x-arrow-pad'
                ));
            var o,
              s = Ve(t, e),
          ...
          u({
            ...
            handler: function (t, e) {
              for (
                var r = t.parser, n = s(e[0], 'ordgroup').body, i = '', a = 0;
                a < n.length;
                a++
              )
                i += s(n[a], 'textord').text;
              var o = parseInt(i);
              if (isNaN(o))
            ...
            htmlBuilder: function (t, e) {
              ...
              return (
                t.newLine &&
                  ...
                  t.size && (r.style.marginTop = Xt(t.size, e) + 'em')),
                r
              );
            },
            mathmlBuilder: function (t, e) {
              ...
              return (
                t.newLine &&
                  ...
                  t.size && r.setAttribute('height', Xt(t.size, e) + 'em')),
                r
              );
            },
          });
        var Ze = function (t, e, r) {
          ...
          tr = function (t, e, r, n, i, a) {
            var o = (function (t, e, r, n) {
              ...
              s = Je(
                oe.makeSpan(['delimsizing', 'size' + e], [o], n),
                W.TEXT,
                n,
                a
              );
          ...
          er = function (t, e, r) {
            ...
            return (
              (n = 'Size1-Regular' === e ? 'delim-size1' : 'delim-size4'),
              {
                ...
                elem: oe.makeSpan(
                  ['delimsizinginner', n],
                  [oe.makeSpan([], [oe.makeSymbol(t, e, r)])]
                ),
              }
            );
          },
          ...
          nr = function (t, e, r, n, i, a) {
            ...
            var A = k / 2 - S,
              M = 0.005 * (w + 1) - p,
              z = [];
            if ((z.push(er(h, c, i)), null === s))
              for (var T = 0; T < w; T++) z.push(rr), z.push(er(l, c, i));
            else {
              for (var C = 0; C < w; C++) z.push(rr), z.push(er(l, c, i));
              z.push({ type: 'kern', size: M }),
                z.push(er(l, c, i)),
                z.push(rr),
                z.push(er(s, c, i));
            ...
            var L = n.havingBaseStyle(W.TEXT),
              N = oe.makeVList(
                { positionType: 'bottom', positionData: A, children: z },
                L
              );
            return Je(
              oe.makeSpan(['delimsizing', 'mult'], [N], L),
              W.TEXT,
              n,
              a
            );
            ...
            return (
              'small' === a.type
                ...
                ? ((c = 1080 * lr[a.size]),
                  ...
                  ((r = ir('sqrtSize' + a.size, l, c, s, e)).style.minWidth =
                    '1.02em'),
                  (n = 1 / o))
                : ((l = t + s + 0.08),
                  (h = t + s),
                  (c = Math.floor(1e3 * t + s) + 80),
                  ((r = ir('sqrtTall', l, c, s, e)).style.minWidth = '0.742em'),
                  (n = 1.056)),
              (r.height = h),
              (r.style.height = l + 'em'),
              {
          ...
          gr = function (t, e, r, n, i) {
            if (
              ('<' === t || '\\lt' === t || '\u27e8' === t
                ...
                : ('>' !== t && '\\gt' !== t && '\u27e9' !== t) ||
                  (t = '\\rangle'),
              R.contains(ar, t) || R.contains(sr, t))
            )
        ...
        u({
          ...
          handler: function (t, e) {
            ...
            return {
              type: 'delimsizing',
              mode: t.parser.mode,
              size: xr[t.funcName].size,
              mclass: xr[t.funcName].mclass,
              delim: r.text,
            };
          },
          htmlBuilder: function (t, e) {
            return '.' === t.delim
              ? oe.makeSpan([t.mclass])
              : gr(t.delim, t.size, e, t.mode, [t.mclass]);
          },
        ...
        var wr = function (t, e) {
            ...
            if ('sout' === a)
              ((r = oe.makeSpan(['stretchy', 'sout'])).height =
              ...
              /box/.test(a)
                ? ((c = Math.max(e.fontMetrics().fboxrule, e.minRuleThickness)),
                  (h = e.fontMetrics().fboxsep + ('colorbox' === a ? 0 : c)))
                : (h = l ? 0.2 : 0),
                (r = je(i, a, h, e)),
            ...
            return (
              ...
              /cancel/.test(a) && !l
                ? oe.makeSpan(['mord', 'cancel-lap'], [n], e)
                : oe.makeSpan(['mord'], [n], e)
            );
          },
          kr = function (t, e) {
            var r = 0,
        ...
        var Sr = {},
          Ar = function (t, e) {
            function r(t) {
              for (var e = 0; e < t.length; ++e)
                e > 0 && (y += 0.25), h.push({ pos: y, isDashed: t[e] });
            }
            var n,
              i,
              a = t.body.length,
            ...
            for (i = 0, T = 0; i < s || T < B.length; ++i, ++T) {
              for (var E = B[T] || {}, O = !0; 'separator' === E.type; ) {
                if (
                  (O ||
                    (((z = oe.makeSpan(['arraycolsep'], [])).style.width =
              ...
              if (!(i >= s)) {
                ...
                for (n = 0; n < a; ++n) {
                  ...
                  if (F) {
                    ...
                    (F.depth = D.depth),
                      (F.height = D.height),
                      P.push({ type: 'elem', elem: F, shift: H });
                  }
                }
                (P = oe.makeVList(
            ...
            if (((l = oe.makeSpan(['mtable'], L)), h.length > 0)) {
              for (
                var j = oe.makeLineSpan('hline', e, c),
                  U = oe.makeLineSpan('hdashline', e, c),
                  V = [{ type: 'elem', elem: l, shift: 0 }];
                h.length > 0;
                ...
                var G = h.pop(),
                  Y = G.pos - C;
                G.isDashed
                  ? V.push({ type: 'elem', elem: U, shift: Y })
                  : V.push({ type: 'elem', elem: j, shift: Y });
              }
              l = oe.makeVList(
          ...
          zr = function (t, e) {
            ...
            if (t.cols) {
              ...
              for (var m = h; m < c; m++)
                'align' === o[m].type
                  ...
                  : 'separator' === o[m].type &&
                    l &&
                    ((s += '|' === o[m].separator ? 'solid ' : 'dashed '),
                    (l = !1));
              r.setAttribute('columnalign', a.trim()),
                /[sd]/.test(s) && r.setAttribute('columnlines', s.trim());
            }
            if ('align' === t.colSeparationType) {
              for (var u = t.cols || [], d = '', p = 1; p < u.length; p++)
                d += p % 2 ? '0em ' : '1em ';
            ...
            for (var v = 1; v < g.length - 1; v++)
              f += 0 === g[v].length ? 'none ' : g[v][0] ? 'dashed ' : 'solid ';
            return (
              /[sd]/.test(f) && r.setAttribute('rowlines', f.trim()),
              '' !== i &&
                (r = new Be.MathNode('menclose', [r])).setAttribute(
                  'notation',
                  i.trim()
                ),
              t.arraystretch &&
                t.arraystretch < 1 &&
                (r = new Be.MathNode('mstyle', [r])).setAttribute(
                  'scriptlevel',
                  '1'
                ),
              r
          ...
          Tr = function (t, e) {
            var r,
              ...
              h = l(e[0], 'ordgroup');
            if (h) {
              for (var c = '', m = 0; m < h.body.length; m++)
                c += s(h.body[m], 'textord').text;
              (r = Number(c)), (a = 2 * r);
            }
            var u = !a;
            i.body.forEach(function (t) {
              for (var e = 1; e < t.length; e += 2) {
                s(s(t[e], 'styling').body[0], 'ordgroup').body.unshift(o);
              }
        ...
        b({
          ...
          handler: function (t, e) {
            var r = {
              cols: (m(e[0]) ? [e[0]] : s(e[0], 'ordgroup').body).map(function (
                t
              ) {
                var e = c(t).text;
          ...
          b({
            ...
            props: { numArgs: 1 },
            handler: function (t, e) {
              var r = (m(e[0]) ? [e[0]] : s(e[0], 'ordgroup').body).map(
                function (t) {
                  var e = c(t).text;
                  if (-1 !== 'lc'.indexOf(e))
              ...
              if ((n = k(t.parser, n, 'script')).body[0].length > 1)
                throw new N('{subarray} can contain only one column');
              return n;
            },
            htmlBuilder: Ar,
        ...
        u({
          ...
          handler: function (t, e) {
            ...
            for (var a = '', o = 0; o < i.body.length; ++o)
              a += s(i.body[o], 'textord').text;
            if ('\\begin' === n) {
              if (!Cr.hasOwnProperty(a))
                throw new N('No such environment: ' + a, i);
              var l = Cr[a],
        ...
        u({
          ...
          handler: function (t, e) {
            ...
            return {
              ...
              mclass: 'm' + n.substr(5),
              body: fe(i),
              isCharacterBox: R.isCharacterBox(i),
            };
          },
          htmlBuilder: A,
          mathmlBuilder: M,
          ...
          u({
            ...
            handler: function (t, e) {
              ...
              return {
                ...
                mclass: r,
                body: [l],
                isCharacterBox: R.isCharacterBox(l),
              };
            },
            htmlBuilder: A,
            mathmlBuilder: M,
        ...
        var qr = function (t, e) {
          ...
          Ir = function (t, e) {
            ...
            if (
              (t.hasBarLine
                ? (t.barSize
                    ? ((c = Xt(t.barSize, e)),
                      (h = oe.makeLineSpan('frac-line', e, c)))
                    : (h = oe.makeLineSpan('frac-line', e)),
                  (c = h.height),
                  (m = h.height))
                : ((h = null),
                  (c = 0),
                  (m = e.fontMetrics().defaultRuleThickness)),
              n.size === W.DISPLAY.size || 'display' === t.size
                ? ((u = e.fontMetrics().num1),
                  (d = c > 0 ? 3 * m : 7 * m),
                  (p = e.fontMetrics().denom1))
                : (c > 0
                    ? ((u = e.fontMetrics().num2), (d = m))
                    : ((u = e.fontMetrics().num3), (d = 3 * m)),
                  (p = e.fontMetrics().denom2)),
              h)
            ) {
              var b = e.fontMetrics().axisHeight;
              u - o.depth - (b + 0.5 * c) < d &&
                (u += d - (u - o.depth - (b + 0.5 * c))),
                b - 0.5 * c - (x.height - p) < d &&
                  (p += d - (b - 0.5 * c - (x.height - p)));
              var w = -(b - 0.5 * c);
              f = oe.makeVList(
                {
                  positionType: 'individualShift',
            ...
            return (
              ...
              (v =
                null == t.leftDelim
                  ? Me(e, ['mopen'])
                  : vr(t.leftDelim, g, !0, e.havingStyle(n), t.mode, [
                      'mopen',
                    ])),
              (y = t.continued
                ? oe.makeSpan([])
                : null == t.rightDelim
                ? Me(e, ['mclose'])
                : vr(t.rightDelim, g, !0, e.havingStyle(n), t.mode, [
                    'mclose',
                  ])),
              oe.makeSpan(
                ['mord'].concat(r.sizingClasses(e)),
                [v, oe.makeSpan(['mfrac'], [f]), y],
                e
              )
            );
          },
          Rr = function (t, e) {
            ...
            if (null != t.leftDelim || null != t.rightDelim) {
              var o = [];
              if (null != t.leftDelim) {
                var s = new Be.MathNode('mo', [
                  new Be.TextNode(t.leftDelim.replace('\\', '')),
                ]);
                s.setAttribute('fence', 'true'), o.push(s);
              }
              if ((o.push(r), null != t.rightDelim)) {
                var l = new Be.MathNode('mo', [
                  new Be.TextNode(t.rightDelim.replace('\\', '')),
                ]);
        ...
        var Dr = function (t, e) {
          ...
          a
            ? ((r = a.sup
                ? ze(a.sup, e.havingStyle(i.sup()), e)
                : ze(a.sub, e.havingStyle(i.sub()), e)),
              (n = s(a.base, 'horizBrace')))
            : (n = s(t, 'horizBrace'));
          var o,
          ...
          u({
            ...
            handler: function (t, e) {
              ...
              return r.settings.isTrusted({ command: '\\href', url: i })
                ? { type: 'href', mode: r.mode, href: i, body: fe(n) }
            ...
            mathmlBuilder: function (t, e) {
              var r = qe(t.body, e);
              return (
                r instanceof Te || (r = new Te('mrow', [r])),
        ...
        u({
          ...
          handler: function (t, e, r) {
            ...
            if (r[0])
              for (
                var h = s(r[0], 'raw').string.split(','), c = 0;
                c < h.length;
                c++
              ) {
                var m = h[c].split('=');
          ...
          htmlBuilder: function (t, e) {
            ...
            t.totalheight.number > 0 &&
              ((n = Xt(t.totalheight, e) - r), (n = Number(n.toFixed(2))));
            var i = 0;
            t.width.number > 0 && (i = Xt(t.width, e));
            var a = { height: r + n + 'em' };
            i > 0 && (a.width = i + 'em'),
              n > 0 && (a.verticalAlign = -n + 'em');
          ...
          mathmlBuilder: function (t, e) {
            ...
            if (
              (t.totalheight.number > 0 &&
                ((i = (i = Xt(t.totalheight, e) - n).toFixed(2)),
          ...
          u({
            ...
            htmlBuilder: function (t, e) {
              var r;
              'clap' === t.alignment
                ? ((r = oe.makeSpan([], [ze(t.body, e)])),
                  (r = oe.makeSpan(['inner'], [r], e)))
                : (r = oe.makeSpan(['inner'], [ze(t.body, e)]));
        ...
        var jr = function (t, e, r, n, i, a, o) {
          ...
          Vr = function (t, e) {
            var r,
              ...
              o = l(t, 'supsub');
            o
              ? ((r = o.sup), (n = o.sub), (i = s(o.base, 'op')), (a = !0))
              : (i = s(t, 'op'));
            var h,
              c = e.style,
              m = !1;
            if (
              (c.size === W.DISPLAY.size &&
                i.symbol &&
                !R.contains(Ur, i.name) &&
                (m = !0),
              i.symbol)
            ) {
              ...
              if (
                (('\\oiint' !== i.name && '\\oiiint' !== i.name) ||
                  ((d = i.name.substr(1)),
                  (i.name = 'oiint' === d ? '\\iint' : '\\iiint')),
                (h = oe.makeSymbol(i.name, u, 'math', e, [
                  'mop',
                  'op-symbol',
                  m ? 'large-op' : 'small-op',
                ])),
              ...
              var g = we(i.body, e, !0);
              1 === g.length && g[0] instanceof at
                ? ((h = g[0]).classes[0] = 'mop')
                : (h = oe.makeSpan(['mop'], oe.tryCombineChars(g), e));
            } else {
              for (var v = [], y = 1; y < i.name.length; y++)
                v.push(oe.mathsym(i.name[y], i.mode, e));
            ...
            return (
              (h instanceof at ||
                ...
                '\\oiiint' === i.name) &&
                !i.suppressBaseShift &&
                ((x = (h.height - h.depth) / 2 - e.fontMetrics().axisHeight),
                (b = h.italic)),
              a
                ? jr(h, r, n, e, c, b, x)
                : (x &&
                    ((h.style.position = 'relative'), (h.style.top = x + 'em')),
                  h)
            );
          },
          Gr = function (t, e) {
            var r;
            if (t.symbol)
              (r = new Te('mo', [Le(t.name, t.mode)])),
                R.contains(Ur, t.name) && r.setAttribute('largeop', 'false');
        ...
        u({
          ...
          mathmlBuilder: function (t, e) {
            for (
              var r = Oe(t.body, e.withFont('mathrm')), n = !0, i = 0;
              i < r.length;
              i++
            ) {
              var a = r[i];
              if (a instanceof Be.SpaceNode);
                ...
                switch (a.type) {
                  ...
                  case 'mo':
                    var o = a.children[0];
                    1 === a.children.length && o instanceof Be.TextNode
                      ? (o.text = o.text
                          .replace(/\u2212/, '-')
                          .replace(/\u2217/, '*'))
                      : (n = !1);
            ...
            return t.parentIsSupSub
              ? new Be.MathNode('mo', [l, h])
              : Be.newDocumentFragment([l, h]);
          },
        }),
          d({
            type: 'ordgroup',
            htmlBuilder: function (t, e) {
              return t.semisimple
                ? oe.makeFragment(we(t.body, e, !1))
                : oe.makeSpan(['mord'], we(t.body, e, !0), e);
            },
            mathmlBuilder: function (t, e) {
          ...
          u({
            ...
            htmlBuilder: function (t, e) {
              ...
              var a = n + i / 4,
                ...
                c = s.advanceWidth,
                m = l.height - h;
              m > r.height + r.depth + a &&
                (a = (a + m - r.height - r.depth) / 2);
            ...
            mathmlBuilder: function (t, e) {
              var r = t.body,
                n = t.index;
              return n
                ? new Be.MathNode('mroot', [Ie(r, e), Ie(n, e)])
                : new Be.MathNode('msqrt', [Ie(r, e)]);
            },
          });
        var Kr = {
          display: W.DISPLAY,
          ...
          d({
            ...
            htmlBuilder: function (t, e) {
              ...
              if (n && i) {
                ...
                var A = [
                  { type: 'elem', elem: i, marginLeft: x, marginRight: y },
                ];
                g = oe.makeVList(
            ...
            mathmlBuilder: function (t, e) {
              ...
              var a,
                o = [Ie(t.base, e)];
              if (
                (t.sub && o.push(Ie(t.sub, e)),
                t.sup && o.push(Ie(t.sup, e)),
                n)
              )
                a = r ? 'mover' : 'munder';
              else if (t.sub)
                ...
                a =
                  ...
                  'op' === c.type &&
                  c.limits &&
                  (e.style === W.DISPLAY || c.alwaysHandleSupSub)
                    ? 'mover'
                    : c &&
                      'operatorname' === c.type &&
                      c.alwaysHandleSupSub &&
                      (c.limits || e.style === W.DISPLAY)
                    ? 'mover'
                    : 'msup';
              }
        ...
        d({
          ...
          htmlBuilder: function (t, e) {
            if (Qr.hasOwnProperty(t.text)) {
              ...
              return oe.makeSpan(
                ['mspace', r],
                [oe.mathsym(t.text, t.mode, e)],
                e
              );
            }
            if (Jr.hasOwnProperty(t.text))
              return oe.makeSpan(['mspace', Jr[t.text]], [], e);
        ...
        d({
          ...
          mathmlBuilder: function (t, e) {
            var r = new Be.MathNode('mtable', [
              new Be.MathNode('mtr', [
                tn(),
                new Be.MathNode('mtd', [qe(t.body, e)]),
                tn(),
                new Be.MathNode('mtd', [qe(t.tag, e)]),
              ]),
            ]);
        ...
        var en = {
          ...
          an = function (t, e) {
            ...
            return r
              ? en[r]
                ? e.withTextFontFamily(en[r])
                : rn[r]
                ? e.withTextFontWeight(rn[r])
                : e.withTextFontShape(nn[r])
              : e;
          };
        u({
          type: 'text',
          ...
          u({
            ...
            htmlBuilder: function (t, e) {
              for (
                var r = on(t), n = [], i = e.havingStyle(e.style.text()), a = 0;
                a < r.length;
                a++
              ) {
                var o = r[a];
                '~' === o && (o = '\\textasciitilde'),
                  n.push(
                    oe.makeSymbol(o, 'Typewriter-Regular', t.mode, i, [
                      'mord',
                      'texttt',
                    ])
                  );
          ...
          mn = (function () {
            ...
            return (
              ...
              (e.lex = function () {
                ...
                return (
                  a && (n = a[1]),
                  new B(n, new C(this, e, this.tokenRegex.lastIndex))
                );
              }),
              t
            );
        ...
        T('\\char', function (t) {
          ...
          if (e) {
            if (null == (n = fn[r.text]) || n >= e)
              throw new N('Invalid base-' + e + ' digit ' + r.text);
            for (var i; null != (i = fn[t.future().text]) && i < e; )
              (n *= e), (n += i), t.popToken();
          }
          return '\\@char{' + n + '}';
        });
        var gn = function (t, e) {
          ...
          if (1 !== r.length)
            throw new N("\\gdef's first argument must be a macro name");
          var n = r[0].text,
            i = 0;
          for (r = t.consumeArgs(1)[0]; 1 === r.length && '#' === r[0].text; ) {
            ...
            if (!/^[1-9]$/.test(r[0].text))
              throw new N('Invalid argument number "' + r[0].text + '"');
            if ((i++, parseInt(r[0].text) !== i))
              throw new N('Argument number "' + r[0].text + '" out of order');
            r = t.consumeArgs(1)[0];
          }
        ...
        T('\\dots', function (t) {
          ...
          return (
            r in yn
              ...
              ? (e = '\\dotsb')
              : r in gt.math &&
                R.contains(['bin', 'rel'], gt.math[r].group) &&
                (e = '\\dotsb'),
            e
          );
        });
        ...
        var bn =
          ht['Main-Regular']['T'.charCodeAt(0)][1] -
          0.7 * ht['Main-Regular']['A'.charCodeAt(0)][1] +
          'em';
        T(
          '\\LaTeX',
            ...
            return (
                  ...
                  if ('{' === n.text) {
                    for (var i = [], a = 1; 0 !== a; ) {
                      ...
                      if ((i.push(o), '{' === o.text)) ++a;
                        ...
                        throw new N('End of input in macro argument', n);
                    }
                    i.pop(), i.reverse(), (e[r] = i);
                  } else {
                    if ('EOF' === n.text)
                      throw new N('End of input expecting macro argument');
                    e[r] = [n];
                  }
                }
                return e;
                  ...
                  for (
                    ...
                    if ('#' === o.text) {
                      ...
                      if ('#' === (o = n[--a]).text) n.splice(a + 1, 1);
                        ...
                        if (!/^[1-9]$/.test(o.text))
                          throw new N('Not a valid argument number', o);
                        var s;
              ...
              (e.expandMacro = function (t) {
                if (this.macros.get(t)) {
                  var e = [],
                    r = this.stack.length;
                  for (this.pushToken(new B(t)); this.stack.length > r; )
                    this.expandOnce() instanceof B && e.push(this.stack.pop());
                  return e;
                }
              }),
                ...
                if ('string' == typeof r) {
                  ...
                  if (-1 !== r.indexOf('#'))
                    for (
                      ...
                      ++n;
                  for (
                    var a = new mn(r, this.settings), o = [], s = a.lex();
                    'EOF' !== s.text;
              ...
              (e.isDefined = function (t) {
                return (
                  this.macros.has(t) ||
                  sn.hasOwnProperty(t) ||
                  gt.math.hasOwnProperty(t) ||
                  gt.text.hasOwnProperty(t) ||
                  wn.hasOwnProperty(t)
                );
              }),
              t
            ...
            return (
              ...
              (e.handleInfixNodes = function (t) {
                for (var e, r = -1, n = 0; n < t.length; n++) {
                  ...
                  if (i) {
                    if (-1 !== r)
                      throw new N('only one infix operator per group', i.token);
                    (r = n), (e = i.replaceWith);
                  }
                }
                if (-1 !== r && e) {
                  ...
                  return (
                    ...
                    [
                      '\\\\abovefrac' === e
                        ? this.callFunction(e, [a, t[r], o], [])
                        : this.callFunction(e, [a, o], []),
                    ]
                  );
                }
                return t;
                ...
                for (;;) {
                  ...
                  if ('\\limits' === i.text || '\\nolimits' === i.text) {
                    ...
                    if (a) {
                      ...
                      if (!(a = l(n, 'operatorname')) || !a.alwaysHandleSupSub)
                        throw new N(
                    ...
                    '^' === this.fetch().text &&
                      ...
                      (e = { type: 'ordgroup', mode: this.mode, body: c });
                  }
                }
                return e || r
                  ? { type: 'supsub', mode: this.mode, base: n, sup: e, sub: r }
                  : n;
              }),
              (e.parseFunction = function (t, e, r) {
                var n = this.fetch(),
                  ...
                  a = sn[i];
                if (!a) return null;
                if ((this.consume(), null != r && a.greediness <= r))
                  throw new N(
                    "Got function '" +
                      i +
                      "' with no arguments" +
                ...
                if ('text' === this.mode && !a.allowedInText)
                  throw new N("Can't use function '" + i + "' in text mode", n);
                if ('math' === this.mode && !1 === a.allowedInMath)
                  throw new N("Can't use function '" + i + "' in math mode", n);
              ...
              (e.parseStringGroup = function (t, e, r) {
                ...
                for (
                  var s, l = '', h = this.fetch(), c = 0, m = h;
                  (s = this.fetch()).text !== i || (r && c > 0);
              ...
              (e.parseRegexGroup = function (t, e) {
                ...
                this.mode = 'text';
                for (
                  var n, i = this.fetch(), a = i, o = '';
                  'EOF' !== (n = this.fetch()).text && t.test(o + n.text);

                )
                  (o += (a = n).text), this.consume();
                if ('' === o)
                  throw new N('Invalid ' + e + ": '" + i.text + "'", i);
              ...
              (e.parseGroup = function (e, r, n, i, a, o) {
                ...
                if (r ? '[' === c : '{' === c || '\\begingroup' === c) {
                  ...
                  null ==
                    (l = this.parseFunction(i, e, n) || this.parseSymbol()) &&
                  '\\' === c[0] &&
                  !wn.hasOwnProperty(c)
                ) {
                  if (this.settings.throwOnError)
                    throw new N('Undefined control sequence: ' + c, h);
            ...
            for (var i = [], o = 0; o < t.length; o++)
              if ('text' === t[o].type) {
                ...
                for (
                  -1 !== (c = s.indexOf(e)) &&
                  ((h = c),
                  i.push({ type: 'text', data: s.slice(0, h) }),
                  (l = !1));
                  ;
          ...
          (r.delimiters = r.delimiters || [
            ...
            (function i(t, e) {
              for (var r = 0; r < t.childNodes.length; r++) {
                ...
                if (3 === n.nodeType) {
                  var a = s(n.textContent, e);
                  (r += a.childNodes.length - 1), t.replaceChild(a, n);
                } else
                  1 === n.nodeType &&
                    (function () {
                      var t = ' ' + n.className + ' ';
                      -1 === e.ignoredTags.indexOf(n.nodeName.toLowerCase()) &&
                        e.ignoredClasses.every(function (e) {
                          return -1 === t.indexOf(' ' + e + ' ');
                        }) &&
                        i(n, e);
                    })();
...
*/
  (function (t, e, r) {
    ...
    function e(t) {
      var e,
        r = typeof t;
      return (
        null == t || ('object' != r && 'function' != r) || (e = t.then),
        'function' == typeof e && e
      );
    }
    function r() {
    ...
    function n(t, r, n) {
      ...
      try {
        !1 === r
          ? n.reject(t.msg)
          : (i = !0 === r ? t.msg : r.call(void 0, t.msg)) === n.promise
          ? n.reject(TypeError('Promise-chain cycle'))
          : (a = e(i))
          ? a.call(i, n.resolve, n.reject)
          : n.resolve(i);
      } catch (o) {
        n.reject(o);
      }
  ...
  (function (t, e) {
    ...
    function o(t, r, n) {
      (t = t.C.getElementsByTagName(r)[0]) || (t = e.documentElement),
    ...
    function h(t, e) {
      for (var r = t.className.split(/\s+/), n = 0, i = r.length; n < i; n++)
        if (r[n] == e) return !0;
      return !1;
    }
    function c(t) {
      ...
      return (
        'about:' == e && (e = t.J.location.protocol),
        'https:' == e ? 'https:' : 'http:'
      );
    }
    function m(t, e) {
    ...
    function f(t) {
      ...
      return (
        (t = Z.exec(t)) &&
          ...
          null !== t[4] &&
            t[4] &&
            (i = /^[0-9]+$/.test(t[4]) ? parseInt(t[4], 10) : t[4])),
        new p(e, r, n, i)
      );
    }
    ...
    function y(t) {
      ...
      return '' != e
        ...
        ? ('Mac_PowerPC' == t
            ? (t = 'Macintosh')
            : 'PlayStation' == t && (t = 'Linux'),
          t)
        : 'Unknown';
    }
    function x(t) {
      if (
        (e = w(t.a, /(OS X|Windows NT|Android) ([^;)]+)/, 2)) ||
        (e = w(t.a, /Windows Phone( OS)? ([^;)]+)/, 2)) ||
        (e = w(t.a, /(iPhone )?OS ([\d_]+)/, 2))
      )
        return e;
      if ((e = w(t.a, /(?:Linux|CrOS|CrKey) ([^;)]+)/, 1)))
        for (var e = e.split(/\s/), r = 0; r < e.length; r += 1)
          if (/^[\d\._]+$/.test(e[r])) return e[r];
      return (t = w(t.a, /(BB\d{2}|BlackBerry).*?Version\/([^\s]*)/, 2))
        ? t
        : 'Unknown';
    }
    function b(t) {
    ...
    function M(t) {
      ...
      return (
        t &&
          ((n = t.match(/(normal|oblique|italic)/i)) &&
            n[1] &&
          ...
          (n = t.match(/([1-9]00|normal|bold)/i)) &&
            ...
            (/bold/i.test(n[1])
              ? (e = 7)
              : /[1-9]00/.test(n[1]) && (e = parseInt(n[1].substr(0, 1), 10)))),
        r + e
      );
    }
    function z(t, e) {
      (this.d = t),
        (this.p = t.t.document.documentElement),
        (this.P = e),
        (this.j = 'wf'),
        (this.h = new k('-')),
        (this.ga = !1 !== e.events),
    ...
    function O(t, e, r, n, i, a, o, s) {
      ...
      (this.ba = o || null),
      (this.F = this.D = null),
      N((t = new L(this.d, this.G))),
      Q))
        Q.hasOwnProperty(l) &&
          ((e = E((e = new S(Q[l], A(this.s))))),
          (t.m.style.cssText = e),
          (this.I[Q[l]] = t.m.offsetWidth));
      t.remove();
    }
    function q(t, e, r) {
      for (var n in Q)
        if (Q.hasOwnProperty(n) && e === t.I[Q[n]] && r === t.I[Q[n]])
          return !0;
      return !1;
    }
    function I(t) {
      ...
      (e === t.I.serif && r === t.I['sans-serif']) || (t.k.fa && q(t, e, r))
        ? K() - t.na >= t.W
          ? t.k.fa &&
            q(t, e, r) &&
            (null === t.ba || t.ba.hasOwnProperty(t.s.getName()))
            ? _(t, t.Z)
            : _(t, t.ja)
          : R(t)
        : _(t, t.Z);
      ...
      if (((r = r || {}), 0 === e.length && a)) T(t.u);
        ...
        for (t.R += e.length, a && (t.aa = a), a = 0; a < e.length; a++) {
          ...
          h.B && l(h.p, [h.h.e(h.j, c.getName(), A(c).toString(), 'loading')]),
            C(h, 'fontloading', c),
            (h = null),
            (h = new O(i(t.ha, t), i(t.ia, t), t.d, o, t.k, t.W, n, s)).start();
        }
    }
    function F(t) {
      0 == --t.R &&
        ...
        (t.da
          ? ((t = t.u).B &&
              l(
                t.p,
                [t.h.e(t.j, 'active')],
                [t.h.e(t.j, 'loading'), t.h.e(t.j, 'inactive')]
              ),
            C(t, 'active'))
          : T(t.u));
    }
    function H(t) {
      (this.J = t),
        (this.v = new B()),
        (this.oa = new v(t.navigator.userAgent)),
    ...
    function j(t, e, r, n, i) {
      ...
      (t.Q || t.S) &&
        setTimeout(function () {
          D(e, r, n || null, i || null, a);
        }, 0);
    }
    function U(t, e, r) {
      (this.O = t || e + tt), (this.q = []), (this.V = []), (this.ea = r || '');
    }
    function V(t) {
    ...
    a.prototype.createElement = function (t, e, r) {
      if (((t = this.C.createElement(t)), e))
        for (var n in e)
          e.hasOwnProperty(n) &&
            ('style' == n ? (t.style.cssText = e[n]) : t.setAttribute(n, e[n]));
      return r && t.appendChild(this.C.createTextNode(r)), t;
    };
    var Z = /^([0-9]+)(?:[\._-]([0-9]+))?(?:[\._-]([0-9]+))?(?:[\._+-]?(.*))?$/;
    (p.prototype.compare = function (t) {
      return this.c > t.c ||
        (this.c === t.c && this.g > t.g) ||
        (this.c === t.c && this.g === t.g && this.A > t.A)
        ? 1
        : this.c < t.c ||
          (this.c === t.c && this.g < t.g) ||
          (this.c === t.c && this.g === t.g && this.A < t.A)
      ...
      if (-1 != this.a.indexOf('MSIE') || -1 != this.a.indexOf('Trident/')) {
        ...
        '' != n && f(n),
          (t = new g(
            ...
            new d(
              ('Windows' == t && 6 <= r.c) ||
                ('Windows Phone' == t && 8 <= e.c),
              !1
            )
          ));
      } else if (-1 != this.a.indexOf('Opera'))
        t: if (
          ((t = f(w(this.a, /Presto\/([\d\w\.]+)/, 1))),
          f(x(this)),
          null !== t.c || f(w(this.a, /rv:([^\)]+)/, 1)),
          -1 != this.a.indexOf('Opera Mini/'))
        )
          (t = f(w(this.a, /Opera Mini\/([\d\.]+)/, 1))),
            (t = new g('OperaMini', 0, 0, 0, y(this), 0, 0, new d(!1, !1)));
        else {
          if (
            -1 != this.a.indexOf('Version/') &&
            null !== (t = f(w(this.a, /Version\/([\d\.]+)/, 1))).c
          ) {
            t = new g('Opera', 0, 0, 0, y(this), 0, 0, new d(10 <= t.c, !1));
            break t;
          }
          t =
            null !== (t = f(w(this.a, /Opera[\/ ]([\d\.]+)/, 1))).c
              ? new g('Opera', 0, 0, 0, y(this), 0, 0, new d(10 <= t.c, !1))
        ...
        /OPR\/[\d.]+/.test(this.a)
          ...
          ? ((t = 'Unknown'),
            ...
            -1 != this.a.indexOf('Firefox')
              ? ((t = 'Firefox'),
                (e =
                  3 <= (e = f(w(this.a, /Firefox\/([\d\w\.]+)/, 1))).c &&
                  5 <= e.g))
    ...
    (O.prototype.start = function () {
      (this.D = new L(this.d, this.G)),
        ...
        N(this.F),
        (this.na = K());
      var t = E((t = new S(this.s.getName() + ',serif', A(this.s))));
      (this.D.m.style.cssText = t),
        (t = E((t = new S(this.s.getName() + ',sans-serif', A(this.s))))),
        (this.F.m.style.cssText = t),
        I(this);
    }),
      (P.prototype.ha = function (t) {
        ...
        e.B &&
          l(
            e.p,
            [e.h.e(e.j, t.getName(), A(t).toString(), 'active')],
            [
              e.h.e(e.j, t.getName(), A(t).toString(), 'loading'),
              e.h.e(e.j, t.getName(), A(t).toString(), 'inactive'),
            ]
          ),
          C(e, 'fontactive', t),
          (this.da = !0),
      ...
      (P.prototype.ia = function (t) {
        ...
        if (e.B) {
          ...
          r || n.push(e.h.e(e.j, t.getName(), A(t).toString(), 'inactive')),
            l(e.p, n, i);
        }
        C(e, 'fontinactive', t), F(this);
      }),
      (H.prototype.load = function (t) {
        (this.d = new a(this.J, t.context || this.J)),
          (this.S = !1 !== t.events),
          (this.Q = !1 !== t.classes);
        ...
        for (
          r = h,
            ...
            t = new P(this.a, this.d, e, n),
            n = 0,
            o = r.length;
          n < o;
          n++
        )
          (s = r[n]).K(this.a, i(this.ka, this, s, e, t));
      }),
      (H.prototype.ka = function (t, e, r, n) {
        ...
        n
          ...
          : ((t = 0 == --this.U),
            ...
            t && 0 == this.T
              ? T(e)
              : (this.Q || this.S) && D(r, [], {}, null, t));
      });
    var tt = '//fonts.googleapis.com/css';
    U.prototype.e = function () {
      if (0 == this.q.length) throw Error('No fonts to load!');
      if (-1 != this.O.indexOf('kit=')) return this.O;
      for (var t = this.q.length, e = [], r = 0; r < t; r++)
        e.push(this.q[r].replace(/ /g, '+'));
      return (
        (t = this.O + '?family=' + e.join('%7C')),
        0 < this.V.length && (t += '&subset=' + this.V.join(',')),
        0 < this.ea.length && (t += '&text=' + encodeURIComponent(this.ea)),
        t
      );
    };
    var et = {
    ...
    V.prototype.parse = function () {
      for (var t = this.q.length, e = 0; e < t; e++) {
        ...
        if (2 <= r.length) {
          ...
          if (((a = []), (o = r[1])))
            for (var o, s = (o = o.split(',')).length, l = 0; l < s; l++) {
              ...
              if ((h = o[l]).match(/^[\w-]+$/)) {
                var c = void 0;
                if (null == (h = it.exec(h.toLowerCase()))) c = '';
                else {
                  if (((c = void 0), null == (c = h[1]) || '' == c)) c = '4';
                  else {
                    var m = rt[c];
                    c = m || (isNaN(c) ? '4' : c.substr(0, 1));
                  }
                  c = [null == (h = h[2]) || '' == h ? 'n' : nt[h], c].join('');
                }
                h = c;
              } else h = '';
              h && a.push(h);
        ...
        for (
          this.L[n] || ((r = et[n]) && (this.L[n] = r)), r = 0;
          r < i.length;
          r += 1
        )
    ...
    (G.prototype.K = function (t, e) {
      ...
      (G.prototype.$ = function (t) {
        for (
          var e = this.d,
            r = new U(this.f.api, c(e), this.f.text),
            n = this.f.families,
            i = n.length,
            a = 0;
          a < i;
        ...
        (n = new V(n)).parse(), m(e, r.e()), t(n.ca, n.L, at);
      }),
      (W.prototype.H = function (t) {
        ...
        return (
          ...
          (e.t.location.hostname || e.J.location.hostname) +
          '/' +
          t +
          '.js'
        );
    ...
    (ot.v.w.custom = function (t, e) {
      ...
      this.WebFont ||
        ((this.WebFont = {}),
        (this.WebFont.load = i(ot.load, ot)),
        this.WebFontConfig && ot.load(this.WebFontConfig));
  })(this, document),
  ...
  [].slice
    ...
    .forEach(function (t) {
      t.setAttribute('data-plaintext', t.textContent);
    }),
  (function () {
    function t() {
      e ||
  ...
  (SL.fonts = {
    ...
    init: function () {
      if (
        ...
        this.loadDeckFont([SLConfig.deck.theme_font || t], {
    ...
    load: function (t, e) {
      ...
      return (
        ...
        t.forEach(function (t) {
          ...
          e
            ? e.loaded || -1 !== i.indexOf(e.name)
              ? 'function' == typeof r.fontactive && r.fontactive(e.name)
              : ((e.loaded = !0),
                r.custom.families.push(e.name),
                r.custom.urls.push(SL.fonts.FONTS_URL + e.path))
    ...
    loadGoogleFont: function (t) {
      WebFont.load({
        google: { families: SL.fonts.parseGoogleFontFamilies(t) },
      });
    },
    ...
    parseGoogleFontFamilies: function (t) {
      return (t = (t = (t = (t || '').trim().split(', ')).map(function (t) {
          ...
          [].slice
            .call(
              document.querySelectorAll(
                'link[href="' + SL.fonts.FONTS_URL + e.path + '"]'
              )
            )
            .forEach(function (t) {
  ...
  (SL('deck').Animation = {
    ...
    getAnimationTargets: function (t) {
      return t instanceof Array
        ? t
        : t.hasAttribute('data-animation-type')
        ? [t]
        : [].slice.call(t.querySelectorAll('[data-animation-type]'));
    },
    ...
    run: function (t, e) {
      this.getAnimationTargets(t).forEach(
        function (t) {
          (!e && this.hasInteractiveAnimationTrigger(t)) ||
              ...
              var r = e.getAttribute('data-animation-trigger-id'),
                n =
                  'self' === r
                    ? e
                    : t.querySelector(
                        '.sl-block[data-block-id="' + r + '"] .sl-block-content'
                      );
              if (n) {
                ...
                'click' === i
                  ? (this.addAnimationEventListener(
                      n,
                      'touchstart',
                      this.onTriggerTouchStart.bind(this, e)
                    ),
                    this.addAnimationEventListener(
                      n,
                      'click',
                      this.onTriggerClick.bind(this, e)
                    ))
                  : 'hover' === i &&
                    (this.addAnimationEventListener(
                      n,
                      'mouseover',
                      this.onTriggerMouseOver.bind(this, e)
                    ),
                    this.addAnimationEventListener(
                      n,
                      'mouseout',
                      this.onTriggerMouseOut.bind(this, e)
                    ));
              }
            }
          }.bind(this)
    ...
    addAnimationEventListener: function (t, e, r) {
      t.addEventListener(e, r),
        /click|touchstart/gi.test(e) && t.classList.add('animation-trigger'),
        this.animationListeners.push([t, e, r]);
    },
    unbind: function () {
      this.animationListeners.forEach(function (t) {
        var e = t[0],
          r = t[1],
          n = t[2];
        /click|touchstart/gi.test(r) && e.classList.remove('animation-trigger'),
    ...
    setSerializedInteractiveState: function (t) {
      ...
      if (e.length && 'string' == typeof t) {
        ...
        e.forEach(function (e) {
          ...
          'string' == typeof a && -1 !== t.indexOf(a) ? n.push(e) : r.push(e);
        }, this),
          this.reset(r),
          this.run(n, !0);
      }
    ...
    getParentBlock: function (t) {
      for (var e = t.parentNode; e && !e.hasAttribute('data-block-id'); )
        e = e.parentNode;
      return e;
    },
    onSlideChanged: function (t) {
      this.animationsEnabled &&
        (t.previousSlide && (this.reset(t.previousSlide), this.unbind()),
        t.currentSlide &&
          (this.run(t.currentSlide), this.bind(t.currentSlide)));
    },
    ...
    findMatchingElements: function (t, e, r, n, i, a) {
      ...
      [].slice.call(e.querySelectorAll(n)).forEach(function (t) {
        ...
        [].slice.call(r.querySelectorAll(n)).forEach(function (e) {
          var r,
            n = i(e);
          if (((s[n] = s[n] || []), s[n].push(e), o[n])) {
            var l = s[n].length - 1,
              h = o[n].length - 1;
            o[n][l]
              ? ((r = o[n][l]), (o[n][l] = null))
              : o[n][h] && ((r = o[n][h]), (o[n][h] = null));
          }
          r && t.push({ from: r, to: e, options: a || { styles: [] } });
        });
    },
    ...
    expandBlockPair: function (t, e, r, n, i, a) {
      ...
      return (
        n.dataset.autoAnimateDelay &&
          (e.options.delay = parseFloat(n.dataset.autoAnimateDelay)),
        n.dataset.autoAnimateDuration &&
          (e.options.duration = parseFloat(n.dataset.autoAnimateDuration)),
        n.dataset.autoAnimateEasing &&
          (e.options.easing = n.dataset.autoAnimateEasing),
        (h['z-index'] = {
          property: 'z-index',
          from: a.style.zIndex,
          to: a.style.zIndex,
        }),
        /text|snippet|table/i.test(l)
      ...
      i &&
        ...
        t.push({
          ...
          options: {
            translate: !1,
            scale: !1,
            styles: [{ property: 'stroke' }, { property: 'stroke-width' }],
          },
        });
    },
    ...
    onAutoAnimate: function (t) {
      ...
      Array.prototype.forEach.call(
        ...
        function (t) {
          ...
          n &&
            e.push(
              '.reveal [data-auto-animate-target="unmatched"][data-block-id="' +
                r +
                '"] { z-index: ' +
                n.style.zIndex +
                '; }'
  ...
  (SL('deck').Media = {
    ...
    switchToCDN: function (t, e) {
      document.querySelectorAll(t).forEach(function (t) {
        var r = t.getAttribute(e);
        0 === r.lastIndexOf(SL.config.S3_HOST, 0) &&
          t.setAttribute(e, r.replace(SL.config.S3_HOST, SL.config.CDN_HOST));
      }, this);
    },
  }),
  (SL('deck').util = {
    ...
    renderMathBlocks: function (t) {
      t || (t = document.querySelector('.reveal .slides')),
        window.katex &&
          ...
          [].slice
            .call(t.querySelectorAll('.sl-block[data-block-type="math"]'))
            .forEach(function (t) {
              ...
              e &&
                ...
                e && r && katex.render(e.innerText, r);
            });
    },
    ...
    injectCodeCopyButtons: function () {
      ...
      t.length &&
        ...
        t.forEach(function (t) {
          ...
          r &&
            (e = r.hasAttribute('data-plaintext')
            ...
            e &&
              t.addEventListener(
                'mouseenter',
                function (t) {
                  this.copyButton.setAttribute('data-code-to-copy', e),
                    t.currentTarget.classList.add('has-copy-button'),
                    t.currentTarget.appendChild(this.copyButton);
                }.bind(this)
              );
        }, this));
    },
    hasNotes: function () {
      if (SLConfig.deck && SLConfig.deck.notes)
        for (var t in SLConfig.deck.notes) return !0;
      return (
    ...
    formatIframe: function (t) {
      t.setAttribute('allowfullscreen', ''),
        t.setAttribute('allow', 'fullscreen');
      var e = t.getAttribute('src') || t.getAttribute('data-src');
      'string' != typeof e || /\.pdf$/i.test(e)
