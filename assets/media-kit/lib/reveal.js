...
!(function (e, t) {
  ...
  var fl = '\t\n\v\f\r                　\u2028\u2029\ufeff',
    ...
    yl = function (e) {
      return function (t) {
        var n = String(vl(t));
        return (
          1 & e && (n = n.replace(pl, '')), 2 & e && (n = n.replace(ml, '')), n
        );
      };
    },
  ...
  var Nl = $e,
    ...
    Oc = function (e, t) {
      ...
      return (
        mc(n, { type: gc, tag: e, description: t }),
        Fl || (n.description = t),
        n
      );
    },
  ...
  wc.prototype[pc] || ic(wc.prototype, pc, wc.prototype.valueOf),
    dc(wc, gc),
    (oc[vc] = !0);
  var _c = $t,
    qc = a,
        ...
        [
          ...
          function (e, r) {
            ...
            for (var f = 0, v = 0, g = []; v < s.length; ) {
              ...
              if (
                null === m ||
                (p = fd(ld(d.lastIndex + (dd ? v : 0)), s.length)) === f
              )
                v = sd(s, v, c);
              else {
  ...
  Nu('search', 1, function (e, t, n) {
    return [
      ...
      function (e) {
        ...
        var s = ph(r, a);
        return (
          gh(r.lastIndex, o) || (r.lastIndex = o), null === s ? -1 : s.index
        );
      },
    ];
  });
  var mh = function (e, t) {
    ...
    Dh =
      'zoom' in Ih.style && !Mh && (Th || /Version\/[\d\.]+.*Safari/.test(Nh)),
    jh = {};
  ...
  Kh(
    { target: 'Array', proto: !0, forced: !ef },
    {
      slice: function (e, t) {
        ...
        for (
          i = new (void 0 === n ? Array : n)(rf(l - s, 0)), r = 0;
          s < l;
          s++, r++
        )
          s in a && Qh(i, r, a[s]);
            ...
            value: function (e, t, n, i, r) {
              ...
              t.classList.contains('fragment') &&
                ...
                e.classList.contains('fragment') &&
                  (e.className.match(cf) || [''])[0] ===
                    (t.className.match(cf) || [''])[0] &&
  ...
  function Wf(e, t) {
    ...
    function oe() {
      if (v.wrapper && !M.isPrintingPDF()) {
        if (!l.disableLayout) {
          ...
          for (
            var n = Array.from(v.wrapper.querySelectorAll(af)),
              i = 0,
              r = n.length;
            i < r;
            i++
    ...
    function Se(e, t, o, s) {
      if (
        ...
        if (0 !== c.length) {
          ...
          var h = n || 0,
            f = i || 0;
          (n = xe(of, void 0 === e ? n : e)),
            (i = xe(sf, void 0 === t ? i : t));
          var p = n !== h || i !== f;
          p || (r = null);
          var m = c[n],
    ...
    function Je() {
      ...
      (u.hasNavigatedVertically = !0),
        (R.isActive() || r || !1 === A.next()) && Pe().down && Se(n, i + 1);
    }
    function Qe() {
      var e,
